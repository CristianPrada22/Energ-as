...
public class CalculoCables {
    ...
    float longitud, demandax, potencia;
    public  int numerotubosVert = 0, numerotubosHorizont = 0;
    float temperatura;
    float capcom, corrp;
    ...
    public int getNumerotubosVert() {
        return numerotubosVert;
    }

    public int getNumerotubosHorizont() {
        return numerotubosHorizont;
    }
   ...
   public float getCorrp() {
    ...
    public void setDemandax(float demandax) {
        this.demandax = demandax;
    }
    ...
    public void setNumerotubosVert(int numerotubosVert) {
        this.numerotubosVert = numerotubosVert;
    }

    public void setNumerotubosHorizont(int numerotubosHorizont) {
        this.numerotubosHorizont = numerotubosHorizont;
    }
    ...
    public void Longitudmenor40() {
        ...
        if (tiposistema == 120) {
            I = (float) ((demandax * 1000) / (1 * tiposistema * 0.9));
        } else {
            I = (float) ((demandax * 1000) / (raiz3 * tiposistema * 0.9));
        }
        fca = facoag(getNumerotubosVert(), getNumerotubosHorizont());
        fct = facote();
        Ipri = I / (fca * fct);
        ...
        deltaV = (tiposistema * potencia) / 100;
        k = Calculok();
